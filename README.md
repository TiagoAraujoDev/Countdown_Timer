...
- In this project I made a timer but like aways I made usable by adding a input to collect the final date from the user. The biggest difficulty was to not allow the user to set a date in the past. My solution was to add the attribute "min" to the date input by javascript using the method setAttribute(), but it didn't work. So I realize that I needed to format the date to set as an atribute value and in this process I learned a lot about strings methods and date format. 
